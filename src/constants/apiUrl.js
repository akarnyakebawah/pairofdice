...
export const overalyImageQueryParams = (campaignUrl, x, y, width, height) => `?rect=${x},${y},${width},${height}&mark=${campaignUrl}&markscale=100&markpad=0&fit=clip&h=1024&w=1024`;

export const overlayImageQuery = (relativeImagePath, campaignUrl, x, y, width, height) => `${resizeImageBasePath()}${relativeImagePath}${overlayImageQueryParams(campaignUrl)}`;
